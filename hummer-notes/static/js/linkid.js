(function () {
  ...
  var q = function (
    a, c, d, b) {
    this.get = function () {
      for (var b = void 0, c = [], d = h.cookie.split(';'), l = new RegExp(
        '^\\s*' + a + '=\\s*(.*?)\\s*$'), f = 0; f < d.length; f++) {
        var n = d[f].match(l)
    ...
    this.set = function (g) {return m(a, g, b, c, 1E3 * d)}
    this.remove = function () {return m(a, '', b, c, -100)}
  }
  var t = function (a, c) {
    var d = void 0
    if ('function' == typeof a.get && 'function' == typeof a.set) {
      var b = c || {},
        ...
        b = a.get('cookieDomain'), l = a.get('cookiePath'),
        f = new q(g, b, r, l)
      d || (d = f.get())
      d && a.set('&linkid', d)
      p(function (a) {
